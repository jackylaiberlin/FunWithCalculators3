...
/**
 * A graphical user interface for the calculator. No calculation is being done here. This class is responsible just for putting up the
 * display on screen. It then refers to the "CalcEngine" to do all the real work.
 * 
